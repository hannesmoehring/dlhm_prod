...
printf "import ssl\nssl._create_default_https_context = ssl._create_unverified_context\n\n" | cat - /home/mohringhannes/unpacked_conda/lib/python3.8/site-packages/clip/clip.py > temp && mv temp /home/mohringhannes/unpacked_conda/lib/python3.8/site-packages/clip/clip.py
